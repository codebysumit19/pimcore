...
class __TwigTemplate_f98d9405d41b64b5883248c5e9d58abf extends Template
{
...
(isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 17, $this->source); })()), 17, $this->source)], false);
        ...
        if (array_key_exists("templates", $context)) {
            ...
            foreach ($context['_seq'] as $context["name"] => $context["template"]) {
                ...
                if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["menu"]) || array_key_exists("menu", $context) ? $context["menu"] : (function () { throw new RuntimeError('Variable "menu" does not exist.', 53, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 54
                    yield "                                            <li class=\"";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed($context["name"], 54, $this->source), "html", null, true);
                    yield " ";
                    ...
                    yield "\">
                                                <a href=\"";
                    // line 55
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("_profiler", ["token" => $this->sandbox->ensureToStringAllowed((isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 55, $this->source); })()), 55, $this->source), "panel" => $this->sandbox->ensureToStringAllowed($context["name"], 55, $this->source), "type" => $this->sandbox->ensureToStringAllowed((isset($context["profile_type"]) || array_key_exists("profile_type", $context) ? $context["profile_type"] : (function () { throw new RuntimeError('Variable "profile_type" does not exist.', 55, $this->source); })()), 55, $this->source)]), "html", null, true);
                    yield "\">";
                    yield $this->sandbox->ensureToStringAllowed((isset($context["menu"]) || array_key_exists("menu", $context) ? $context["menu"] : (function () { throw new RuntimeError('Variable "menu" does not exist.', 55, $this->source); })()), 55, $this->source);
                    yield "</a>
                                            </li>
                                        ";
                }
    ...
    {
        return array (  344 => 70,  330 => 32,  324 => 31,  321 => 30,  308 => 29,  295 => 63,  291 => 61,  287 => 59,  273 => 58,  265 => 55,  258 => 54,  255 => 53,  249 => 49,  241 => 48,  239 => 47,  236 => 46,  219 => 45,  216 => 44,  213 => 43,  210 => 42,  207 => 41,  204 => 40,  202 => 39,  199 => 38,  197 => 37,  193 => 35,  191 => 29,  187 => 27,  174 => 26,  163 => 20,  159 => 18,  157 => 17,  156 => 16,  155 => 15,  154 => 14,  153 => 13,  152 => 12,  149 => 11,  146 => 10,  143 => 9,  130 => 8,  114 => 71,  112 => 70,  108 => 69,  102 => 65,  100 => 26,  93 => 21,  91 => 8,  85 => 5,  82 => 4,  69 => 3,  46 => 1,);
    }
...
{% endblock %}
", "@WebProfiler/Profiler/layout.html.twig", "/var/www/my-project/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/layout.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = ["extends" => 1, "block" => 8, "if" => 9, "set" => 10, "for" => 45, "with" => 48];
        static $filters = ["default" => 10, "format" => 12, "filter" => 45, "escape" => 54, "raw" => 55, "merge" => 32];
        static $functions = ["include" => 5, "path" => 55, "source" => 31];

        try {
            $this->sandbox->checkSecurity(
                ['extends', 'block', 'if', 'set', 'for', 'with'],
                ['default', 'format', 'filter', 'escape', 'raw', 'merge'],
                ['include', 'path', 'source'],
                $this->source
            );
