...
class ConfigLocationConfig 
{
    ...
    /**
     * @default {"write_target":{"type":"symfony-config","options":{"directory":"\/var\/www\/my-project\/var\/config\/admin_system_settings"}},"read_target":{"type":null,"options":{"directory":null}}}
     */
    ...
    {
        if (array_key_exists('admin_system_settings', $config)) {
            $this->_usedProperties['adminSystemSettings'] = true;
            $this->adminSystemSettings = new \Symfony\Config\PimcoreAdmin\ConfigLocation\AdminSystemSettingsConfig($config['admin_system_settings']);
            unset($config['admin_system_settings']);
        }
