...
class PredefinedPropertiesConfig 
{
    ...
    /**
     * @default {"type":"symfony-config","options":{"directory":"\/var\/www\/my-project\/var\/config\/predefined_properties"}}
     */
    ...
    public function __construct(array $config = [])
    {
        if (array_key_exists('write_target', $config)) {
            $this->_usedProperties['writeTarget'] = true;
            $this->writeTarget = new \Symfony\Config\Pimcore\ConfigLocation\PredefinedProperties\WriteTargetConfig($config['write_target']);
