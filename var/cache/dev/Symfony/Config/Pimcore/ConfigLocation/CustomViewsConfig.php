...
class CustomViewsConfig 
{
    ...
    /**
     * @default {"type":"symfony-config","options":{"directory":"\/var\/www\/my-project\/var\/config\/custom_views"}}
     */
    ...
    public function __construct(array $config = [])
    {
        if (array_key_exists('write_target', $config)) {
            $this->_usedProperties['writeTarget'] = true;
            $this->writeTarget = new \Symfony\Config\Pimcore\ConfigLocation\CustomViews\WriteTargetConfig($config['write_target']);
