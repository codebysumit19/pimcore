...
class TwigConfig 
{
    ...
    {
        if (array_key_exists('sandbox_security_policy', $config)) {
            $this->_usedProperties['sandboxSecurityPolicy'] = true;
            $this->sandboxSecurityPolicy = new \Symfony\Config\Pimcore\TemplatingEngine\Twig\SandboxSecurityPolicyConfig($config['sandbox_security_policy']);
            unset($config['sandbox_security_policy']);
        }
