...
class getWebDavControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.bFaKkWs'] ?? $container->load('get_ServiceLocator_BFaKkWsService'))->withContext('Pimcore\\Bundle\\CoreBundle\\Controller\\WebDavController', $container));
