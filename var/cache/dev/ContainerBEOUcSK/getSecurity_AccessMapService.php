...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\ChainRequestMatcher([($container->privates['.security.request_matcher.3pO6EQn'] ??= new \Symfony\Component\HttpFoundation\RequestMatcher\PathRequestMatcher('^/asset/webdav'))]), ['ROLE_PIMCORE_USER'], NULL);
