...
class getResponseExceptionListenerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['Pimcore\\Bundle\\CoreBundle\\EventListener\\ResponseExceptionListener'] = $instance = new \Pimcore\Bundle\CoreBundle\EventListener\ResponseExceptionListener($a, ($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), $b, ($container->services['Pimcore\\Model\\Document\\Service'] ??= new \Pimcore\Model\Document\Service()), ($container->services['Pimcore\\Http\\Request\\Resolver\\SiteResolver'] ?? self::getSiteResolverService($container)));
