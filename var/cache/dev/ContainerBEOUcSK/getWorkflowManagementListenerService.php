...
class getWorkflowManagementListenerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->services['Pimcore\\Workflow\\Place\\StatusInfo'] ?? $container->load('getStatusInfoService'));

        if (isset($container->services['Pimcore\\Bundle\\AdminBundle\\EventListener\\WorkflowManagementListener'])) {
            return $container->services['Pimcore\\Bundle\\AdminBundle\\EventListener\\WorkflowManagementListener'];
        }
        $c = ($container->privates['Pimcore\\Bundle\\AdminBundle\\Service\\Workflow\\ActionsButtonService'] ?? $container->load('getActionsButtonServiceService'));

        if (isset($container->services['Pimcore\\Bundle\\AdminBundle\\EventListener\\WorkflowManagementListener'])) {
            return $container->services['Pimcore\\Bundle\\AdminBundle\\EventListener\\WorkflowManagementListener'];
        }

        return $container->services['Pimcore\\Bundle\\AdminBundle\\EventListener\\WorkflowManagementListener'] = new \Pimcore\Bundle\AdminBundle\EventListener\WorkflowManagementListener($a, $b, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), $c);
    }
}
